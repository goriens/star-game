...
const Level3: React.FC<{
  ...
  // fallback config in case parent doesn’t pass one
  const defaultConfig = {
    title: 'Level 3: Spot the Stars!',
    description: 'Now with more shapes! Place the stickers only on stars.',
  }
      ...
      <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-b from-green-50 via-white to-blue-50 text-center">
        <AnimatePresence>
          ...
          >
            ...
            <p className="text-lg text-gray-700">You matched all the stars perfectly!</p>
            <Button
